...
class _ResultsState extends State<Results> {
  ...
  Future<void> _runModel() async {
    final thisResult = await classifyPineapple(File(widget.imagePath));
    setState(() {
                            ...
                            children: [
                              ...
                              Text(
                                confidence == 0.5
                                    ? "Highly uncertain (50%)"
                                    : confidence < 0.4
                                    ? "Certainly Healthy (${(confidence * 100).toStringAsFixed(0)}% damage probability)"
                                    : confidence > 0.6
                                    ? "Certainly Damaged (${(confidence * 100).toStringAsFixed(0)}%)"
                          ...
                          Text(
                            result == "Mechanically Damaged"
                                ? "• This pineapple shows signs of damage\n"
                                    "• Best used immediately or reject\n"
                                    "• Check for soft spots, cuts or discoloration"
